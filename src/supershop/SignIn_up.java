...
public class SignIn_up extends javax.swing.JFrame {
        ...
        */
        ...
        JOptionPane.showMessageDialog(null,"please enter your gender" );
            ...
            try{
                ...
                int i= st.executeUpdate("INSERT INTO customer_details(name,C_id,password,email,gender) VALUES ('"+ name +"','"+ user_id +"','"+ pswd +"','"+ email +"','"+ gender +"')");
    ...
    private void button4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button4ActionPerformed
        ...
        try{
            ...
            ResultSet resultSet = statement.executeQuery(" select C_id,password from customer where user_id='"+ user_id +"' and password='"+ pswd +"' ");
